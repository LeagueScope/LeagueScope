/* Player historical skeleton — profile card + collapsible sections */
import '../loading.css';

export default function PlayerHistoricalLoading() {
  return (
    <div className="sk-wrap">
      ...
      {['sk-w160', 'sk-w120', 'sk-w200', 'sk-w160'].map((w, i) => (
        <div key={i} className="sk-section">
          ...
          {i === 1 && (
            <div className="sk-section-body">
              <div className="sk-bone sk-full sk-h120" /> {/* Chart placeholder */}
            </div>
          )}
          {i === 2 && (
            <div className="sk-section-body">
              <div className="sk-champ-grid">
                {Array.from({ length: 8 }).map((_, j) => (
                  <div key={j} className="sk-champ-item">
