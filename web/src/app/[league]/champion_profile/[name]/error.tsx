...
export default function ChampionProfileError({
  error,
  reset,
}: {
  ...
  return (
    ...
    >
      ...
      <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#f8fafc', margin: 0 }}>
        Campeón no disponible
      </h2>
      <p style={{ color: '#7a8ba0', fontSize: '0.9rem', maxWidth: 400, margin: 0 }}>
        No se ha podido cargar el perfil de este campeón. Es posible que no tenga datos en esta liga o que el servidor no responda.
      </p>
