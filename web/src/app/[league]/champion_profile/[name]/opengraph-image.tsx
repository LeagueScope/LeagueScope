...
export const alt = 'LeagueScope Champion Profile';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: 'absolute', top: '-150px', left: '50%', width: '600px', height: '600px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(234,179,8,0.2) 0%, transparent 60%)', transform: 'translateX(-50%)', display: 'flex' }} />
        {/* Label */}
        ...
        {/* Champion name */}
        <span style={{ fontSize: champName.length > 10 ? '80px' : '100px', fontWeight: 900, color: '#ffffff', letterSpacing: '-3px', lineHeight: 1 }}>
          {champName}
        </span>
        {/* League badge */}
